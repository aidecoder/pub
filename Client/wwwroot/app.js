...
var config = {
    ...
    authority: "http://localhost:5590", // Адрес нашего IdentityServer
    ...
    redirect_uri: "http://localhost:5593/callback.html",
    ...
    post_logout_redirect_uri: "http://localhost:5593/index.html",
...
function api() {
    ...
    requestUrl(mgr, "http://localhost:5591/identity");
}

function getSuperpowers() {
    // этот endpoint доступен только админам
    requestUrl(mgr, "http://localhost:5591/superpowers");
}
